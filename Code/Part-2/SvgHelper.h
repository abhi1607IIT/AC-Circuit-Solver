...
void make_element_vertical(int x1,int y1,int x2,int y2,char type,char* name, FILE* ptr);
void make_element_horizontal(int x1,int y1,int x2,int y2,char type,char* name, FILE* ptr);
...
void draw_text_vertical(int x, int y, char* text, char type, FILE* ptr);
void draw_text_horizontal(int x, int y, char* text, char type, FILE* ptr);
...
void end_svg(FILE* ptr)
{
	...
	fprintf(ptr,"<path class=\"button\" onclick=\"pan( 0, 0.6)\" d=\"M50 10 l12   20 a40, 70 0 0,0 -24,  0z\" />\n");
	fprintf(ptr,"<path class=\"button\" onclick=\"pan( 0.6, 0)\" d=\"M10 50 l20  -12 a70, 40 0 0,0   0, 24z\" />\n");
	fprintf(ptr,"<path class=\"button\" onclick=\"pan( 0,-0.6)\" d=\"M50 90 l12  -20 a40, 70 0 0,1 -24,  0z\" />\n");
	fprintf(ptr,"<path class=\"button\" onclick=\"pan(-0.6, 0)\" d=\"M90 50 l-20 -12 a70, 40 0 0,1   0, 24z\" />\n");
	fprintf(ptr,"  \n");
